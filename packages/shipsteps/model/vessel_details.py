...
class Table(object):
    def config_db(self,pkg):
        ...
        tbl.column('callsign', size=':10', name_short='!![en]Call sign')
        ...
        tbl.column('vessel_type_code',size='0:3',name_short='!![en]Vessel type').relation('vessel_type.code',relation_name='vesseltype', mode='foreignkey', onDelete='raise')
