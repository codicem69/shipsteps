...
class Table(object):
    def config_db(self,pkg):
        tbl=pkg.table('checklist', pkey='id', name_long='!![en]Checlist', name_plural='!![en]Checklist',caption_field='movtype')
        self.sysFields(tbl)
        ...
        tbl.aliasColumn('movtype','@movtype_id.hierarchical_descrizione')