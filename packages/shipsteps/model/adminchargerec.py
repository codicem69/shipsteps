...
class Table(object):
    def config_db(self,pkg):
        ...
        tbl.column('prot',name_long='!![en]Admin charge number')
    ...
    def counter_prot(self,record=None):
        return dict(format='$NNNNN', code='', period='YY', date_field='data', showOnLoad=True, date_tolerant=True, recycle=True)
