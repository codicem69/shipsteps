...
class Table(object):
    def config_db(self,pkg):
       ...
       # tbl.aliasColumn('transit_cargo','@cargo_transit_arr.transit_cargo')
        ...
        tbl.formulaColumn('etc_email',"""CASE WHEN $etc IS NOT NULL THEN :etcdescr || to_char($etc, :df) || ' WP/AGW<br>' ELSE '' END""", dtype='T',var_etcdescr='ETC:...........',var_df='DD/MM/YYYY HH:MI')
        tbl.formulaColumn('ets_email',"""CASE WHEN $ets IS NOT NULL THEN :etsdescr || to_char($ets, :df) || ' WP/AGW<br>' ELSE '' END""", dtype='T',var_etsdescr='ETS:...........',var_df='DD/MM/YYYY HH:MI')
