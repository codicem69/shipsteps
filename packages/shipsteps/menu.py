    ...
    def config(self,root,**kwargs):
        ...
        if 'admin' in tag_user or 'superadmin' in tag_user or '_DEV_' in tag_user:    
           ...
           # shipsteps.packageBranch('Orgn',pkg='orgn')
            ...
            shipsteps.thpage(u"!![en]Checklist", table="shipsteps.checklist", tags="")
            shipsteps.thpage(u"!![en]Movements type", table="shipsteps.mov_type", tags="")
            ...
            shipsteps.thpage(u"!![en]Daily quantity by destination", table="shipsteps.qt_destino", tags="")
            shipsteps.thpage(u"!![en]Trucks details SOF", table="shipsteps.sof_trucks", tags="")
            shipsteps.thpage(u"!![en]Stamps", table="shipsteps.bolli", tags="")
            shipsteps.thpage(u"!![en]Task list", table="shipsteps.tasklist", tags="")
            shipsteps.thpage(u"!![en]Task list check", table="shipsteps.tasklist_check", tags="")
