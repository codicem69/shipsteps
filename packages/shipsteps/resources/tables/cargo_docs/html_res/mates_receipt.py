...
class Main(TableScriptToHtml):
    ...
    def docHeader(self, header):
        ...
        row = layout.row()
        row.cell("""<center><div style='font-size:20pt;'><strong>MATE'S RECEIPT</strong><br></div></center>::HTML""", width=100)
    ...
    def docFooter(self, footer, lastPage=None):
        l = footer.layout('totali_fattura',top=1,border_width=0,
                           lbl_class='cell_label', 
                           content_class = 'center_cell')
        r = l.row(height=5)
        r.cell()
        r.cell('RECEIVED ON BOARD <br> Officer in charge::HTML', style="text-align:center",  width=100)
