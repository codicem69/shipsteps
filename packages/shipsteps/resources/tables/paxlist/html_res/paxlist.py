...
class Main(TableScriptToHtml):
    ...
    def gridStruct(self,struct):
        ...
        r.fieldcell('birth_date',mm_width=16, content_class="breakword")
        r.fieldcell('birth_place',mm_width=0, content_class="breakword")
        r.fieldcell('birth_country',mm_width=0, content_class="breakword")
        r.fieldcell('gender',mm_width=10, content_class="breakword")
        r.fieldcell('id_doc',mm_width=15, content_class="breakword")
        ...
        r.fieldcell('transit',mm_width=12, content_class="breakword")
        r.fieldcell('visa_n',mm_width=20, content_class="breakword", name='Visa number if appropriate')
