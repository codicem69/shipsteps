...
class View(BaseComponent):
    ...
    def th_struct(self,struct):
        ...
        r.fieldcell('draft_aft_arr', width='3em')
        r.fieldcell('draft_fw_arr', width='3em')
        r.fieldcell('draft_aft_dep', width='3em')
        r.fieldcell('draft_fw_dep', width='3em')
        r.fieldcell('firma_div',width='5em')
        r.fieldcell('mandatory', width='16em')
        r.fieldcell('dock_id', width='5em')
        r.fieldcell('info_moor', width='6em')
        r.fieldcell('master_name', width='6em')
        r.fieldcell('n_crew', width='3em')
        r.fieldcell('n_passengers', width='3em', name='Pax no.')
        ...
        r.fieldcell('invoice_det_id', width='30em')
       ...
       #r.fieldcell('@cargo_lu_arr.description', name= 'cargo_descr', width='5em')
        ...
        r.fieldcell('cargo_lu_en', width='30em')
        r.fieldcell('@cargo_lu_arr.tot_cargo', width='8em')
