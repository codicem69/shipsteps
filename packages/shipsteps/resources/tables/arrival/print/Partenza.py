    ...
    def result_handler_pdf(self, resultAttr):
        ...
        if not save_as:
            if len(self.results)>1:
                save_as = 'multiple_comunicazione_partenza' #slugify(self.batch_title)
            else:
        ...
        body_msg=(sal + '<br><br>' + "si allega comunicazione di partenza " +str(vessel_type) + ' ' + str(vessel_name) + '<br><br>')
