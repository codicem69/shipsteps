...
class Main(TableScriptToHtml):
    ...
    def datiDomanda(self):
       ...
       # layout.row(height=10).cell("<div style='font-size:20pt;padding:5px'><strong>Dati Anagrafici</strong></div>::HTML")
        ...
        dati_operazioni = layout.row(height=45,lbl_height=4, lbl_class='smallCaption')
    ...
    def datiNave(self, row):
        ...
        terza_col.row(height=5).cell(self.parameter('eliche'),font_size='9pt', font_weight='bold')
        terza_col.row(height=5).cell(self.parameter('eliche_poppa'),font_size='9pt', font_weight='bold')
        ...
        quinta_col.row(height=5).cell(self.parameter('eliche_prua'),font_size='9pt', font_weight='bold')
    ...
    def datiOperazioni(self,row):
        ...
        datioper= "<div style='text-align: center;padding: 130px 0;-webkit-transform: rotate(-90deg);'>OPERAZIONI COMMERCIALI</div>" + '::HTML'
        prima_col.row().cell(datioper, font_weight='bold', background='lightgrey')
        seconda_col = row.cell(width=20).layout(name='descr2', um='mm', border_color='black', lbl_class='smallCaption',hasBorderTop=True,hasBorderLeft=True,
                                    lbl_height=3, style='line-height:2,5mm;',width=20,content_class='cellheader')
        seconda_col.row().cell('CARICO A BORDO ', font_weight='bold', background='lightgrey')
        car= "<div style='text-align: center;padding: 50% 0;'>CARICO</div>" + '::HTML'
        seconda_col.row(height=30).cell(car, font_weight='bold', background='lightgrey')
        seconda_col.row().cell('CARICO IN TRANSITO', font_weight='bold', background='lightgrey')
        

        terza_col = row.cell(width=90).layout(name='descr3', um='mm', border_color='black', lbl_class='smallCaption',hasBorderTop=True,
                                    lbl_height=3, style='line-height:2,5mm;',width=90,content_class='celldata')
        terza_col.row().cell("{cargoonboard}::HTML".format(cargoonboard=self.field('cargo_onboard')),font_size='8pt', font_weight='bold')
        terza_col.row(height=30).cell("{cargo}::HTML".format(cargo=self.field('caricoarrivo')),font_size='8pt', font_weight='bold')
        terza_col.row().cell("{cargotransit}::HTML".format(cargotransit=self.field('transit_cargo')),font_size='8pt', font_weight='bold')
        
         
        quarta_col = row.cell(width=5).layout(name='descr4', um='mm', border_color='black', lbl_class='',hasBorderTop=True,hasBorderLeft=True,
                                    vertical_align= 'middle',lbl_height=3, style='line-height:2,5mm;',width=5,content_class='cellheader')
        quarta_col.row().cell('(**) ', font_weight='bold', background='lightgrey')
        quarta_col.row(height=30).cell('(**) ', font_weight='bold', background='lightgrey')
        quarta_col.row().cell('(**) ', font_weight='bold', background='lightgrey')

        quinta_col = row.cell().layout(name='descr5', um='mm', border_color='black', lbl_class='',hasBorderTop=True,
                                    vertical_align= 'middle',lbl_height=3, style='line-height:5mm;',content_class='celldata')
        quinta_col.row().cell(self.parameter('carbordo'),font_size='9pt', font_weight='bold')
        quinta_col.row(height=30).cell(self.parameter('car'),font_size='9pt', font_weight='bold')
        quinta_col.row().cell(self.parameter('cartra'),font_size='9pt', font_weight='bold')
    ...
    def datiOperazioni2(self,row):
        ...
        terza_col.row(height=5).cell(self.parameter('lavori'),font_size='8pt', font_weight='bold')
        terza_col.row(height=5).cell(self.parameter('altre_notizie'),font_size='8pt', font_weight='bold')
    ...
    def datiFirma(self, row):
        ...
        #timbro=self.page.externalUrl('_storage/site/image/sUUOsfcKMnGSYf0jZ7QAzQ.png?_pc=821&v_x=94.5&v_y=95&v_z=0.34&v_r=0&v_h=150&v_w=150')
        firma.row().cell("""<img src="%s" width="100" height="100">::HTML""" %timbro,width=0,content_class='aligned_center')
...
#
    def outputDocName(self, ext=''):
        return 'Domanda_Accosto_{cliente}.{ext}'.format(cliente=self.record['@vessel_details_id.@imbarcazione_id.nome'], ext=ext)
