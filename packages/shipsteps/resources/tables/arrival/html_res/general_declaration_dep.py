...
class Main(TableScriptToHtml):
    ...
    def datiDeclaration(self):
        ...
        layout.row(height=7).cell("<div style='font-size:12pt;padding:5px;text-align: center'><strong>Partenza/Departure</strong></div>::HTML")
    ...
    def datiGeneral1(self, row):
        ...
        cel_port=col2.row(height=10).cell(self.field('@agency_id.@port.descrizione'), font_weight='bold',lbl='2.Porto di Partenza - Port of departure')
        col3=cel_port.row.cell().layout(name='col3', um='mm', border_color='black', lbl_class='smallCaption',
                                    vertical_align= 'middle',lbl_height=3, style='line-height:5mm;',content_class='cellheader')
        col3.row(height=10).cell(self.field('@time_arr.sailed'),font_size='9pt', font_weight='bold', lbl='3.Data e ora di Partenza - Date time of departure')
        ...
        cel_lp=col2.row(height=10).cell(self.field('nextport'), font_weight='bold',lbl='6.Porto di destinazione - Next port of call')
        ...
        col_lpdep.row().cell(self.field('eta_np'),font_size='9pt', font_weight='bold', lbl="6.1 ETA porto di destinazione - ETA next port")
    ...
    def datiGeneral2(self, row):
        ...
        col1.row(height=10).cell(str(self.field('@agency_id.@port.descrizione')) + ' / ' + str(self.field('nextport')), font_weight='bold', 
        ...
        if len(car) == 0:
            car ='IMBARCATO: NIL<br>'

        descr_car= car + cargotransit + '::HTML'
    ...
    def datiGeneral3(self, row):
       ...
       #                            vertical_align= 'middle',lbl_height=3, style='line-height:5mm;',content_class='cellheader')
        col2.row(height=10).cell('', font_weight='bold', lbl='16. Remarks')
    ...
    def outputDocName(self, ext=''):
        ...
        return 'Fal1_dep_{vessel}.{ext}'.format(vessel=vessel,ext=ext)
