...
class FormFromCertificates(BaseComponent):
    ...
    def th_bottom_custom(self, bottom):
        ...
        if serv_len > 1:                    
            btn_istanza_email.dataRpc('nome_temp', self.print_template_istanzacert,record='=#FORM.record',record_arr='=#FORM/parent/#FORM.record',servizio=['capitaneria'], email_template_id='email_certificate_cp',
                                imbarcazione_id='=#FORM/parent/#FORM.record.@vessel_details_id.imbarcazione_id',nome_template = 'shipsteps.istanza_cp_cert:certificate_app',format_page='A4',
    ...
    @public_method
    def print_template_istanzacert(self, record, record_arr=None,imbarcazione_id=None, resultAttr=None, nome_template=None, email_template_id=None,servizio=[] , format_page=None, **kwargs):
        #msg_special=None
        record_id=record['id']
        #print(x)
       #if selId is None:
